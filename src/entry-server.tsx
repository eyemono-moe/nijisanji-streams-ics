		...
		document={({ assets, children, scripts }) => (
			<html lang="en">
				<head>
					...
					<meta
						name="description"
						content="にじさんじライバーの配信予定のカレンダーファイル(iCal形式)を生成します | 特定のライバーのみを選択して生成することも可能です"
					/>
					...
					<meta
						property="og:url"
						content="https://nijisanji-streams-ics.pages.dev"
					/>
					...
					<meta
						property="og:image"
						content="https://nijisanji-streams-ics.pages.dev/OGP.webp"
					/>
